...
// SunIcon / MoonIcon — the theme toggle. Sun shows while dark (click → light),
// moon shows while light (click → dark).
export function SunIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} style={{ flexShrink: 0 }} aria-hidden>
      <circle cx="12" cy="12" r="4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <path
...
// MessageIcon — a speech bubble, the "leave feedback" glyph.
